...
const CouponsSchema = new mongoose.Schema({}, { strict: false });
const Coupons = mongoose.model('Coupons', CouponsSchema, 'Coupons');
...
async function fetchBannerss(page = 1, limit = 10) {
    ...
    const totalDocs = await Coupons.countDocuments();
